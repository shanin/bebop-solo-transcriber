...
def main(args):
    ...
    dataset_train = ConcatDataset([filosax_train_segments_easy, filosax_train_segments_med, weimar_segments])
    len_easy = len(filosax_train_segments_easy)
    len_med = len(filosax_train_segments_med)
    len_weimar = len(weimar_segments)
    ...
    weights = [weight_a] * len_easy + [weight_b] * len_med + [weight_weimar] * len_weimar
